...
/**
 * The Forms class exposes key methods for reading, updating and deleting a form
 *
 * @method Forms forms()
 */
class Forms extends ResourceAbstract
{
